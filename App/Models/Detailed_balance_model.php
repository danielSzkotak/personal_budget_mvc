...
use PDO;
 ...
 public function getCurrentYearDetailedExpenses($userID){
    ...
    $sql = "SELECT expenses.id, expenses_category_assigned_to_users.name, expenses.amount, expenses.date_of_expense FROM expenses_category_assigned_to_users, expenses WHERE (expenses.date_of_expense BETWEEN '$firstDayOfTheYear' AND '$lastDayOfTheYear') AND (expenses_category_assigned_to_users.user_id=:userID) AND (expenses_category_assigned_to_users.user_id = expenses.user_id) AND (expenses.expense_category_assigned_to_user_id=expenses_category_assigned_to_users.id) ORDER BY expenses.amount DESC;";
 ...
 public function getCustomDatesDetailedExpenses($userID, $startDate, $endDate){
    ...
    $sql = "SELECT expenses.id, expenses_category_assigned_to_users.name, expenses.amount, expenses.date_of_expense FROM expenses_category_assigned_to_users, expenses WHERE (expenses.date_of_expense BETWEEN '$startDate' AND '$endDate') AND (expenses_category_assigned_to_users.user_id=:userID) AND (expenses_category_assigned_to_users.user_id = expenses.user_id) AND (expenses.expense_category_assigned_to_user_id=expenses_category_assigned_to_users.id) ORDER BY expenses.amount DESC;";
